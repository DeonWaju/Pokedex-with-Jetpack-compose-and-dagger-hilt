...
import com.example.pokedexappwithjetpackcompose.data.PokemonListEntry
import com.example.pokedexappwithjetpackcompose.repository.PokemonRepository
import com.example.pokedexappwithjetpackcompose.util.Constants.PAGE_SIZE
...
/**
 * Created by Gideon Olarewaju on 22/11/2022.
 */
...
class PokemonListViewModel @Inject constructor(
    ...
    fun searchPokemonList(query: String) {
        val listToSearch = if (isSearchEmpty) {
            pokemonList.value
        } else {
            cachedPokemonList
        }
    ...
    fun loadPokemonPaginated() {
        viewModelScope.launch {
            ...
            val result = repository.fetchPokemonList(PAGE_SIZE, currentPage * PAGE_SIZE)
